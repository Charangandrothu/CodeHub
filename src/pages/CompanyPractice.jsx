...
const CompanyPractice = () => {
    ...
    const totalSession = sessionStats.correct + sessionStats.wrong + sessionStats.skipped;
            ...
            >
                ...
                <div className="mb-6 p-4 rounded-2xl border border-white/[0.07] bg-white/[0.02]">
                    ...
                    <div className="flex items-center gap-4 mt-3">
                        ...
                        <span className="ml-auto text-xs text-zinc-500">Q {currentIndex + 1}/{questions.length}</span>
                    </div>
                </div>
                    ...
                    >
                        ...
                        <div className="p-5 sm:p-6 border-b border-white/[0.05]">
                            <div className="flex items-start justify-between gap-3 mb-3">
                                <span className={`text-[10px] px-2.5 py-0.5 rounded-full border font-bold uppercase tracking-wider ${
                                    currentQ.difficulty === 'Easy' ? 'text-emerald-400 bg-emerald-500/10 border-emerald-500/20' :
                                ...
                                return (
                                    ...
                                    >
                                        <span className={`w-7 h-7 rounded-lg flex items-center justify-center text-xs font-bold shrink-0 border transition-all ${
                                            submitted && opt.key === result?.correctAnswer
                                        ...
                                        <span className={`text-sm leading-relaxed ${
                                            submitted && opt.key === result?.correctAnswer ? 'text-emerald-300' :
                                            submitted && isSelected && !result?.isCorrect ? 'text-red-300' :
                        ...
                        <AnimatePresence>
                            {submitted && result && (
                                ...
                                >
                                    <div className={`mx-5 sm:mx-6 mb-3 p-4 rounded-xl border ${
                                        result.isCorrect
