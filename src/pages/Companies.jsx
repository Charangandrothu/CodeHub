...
const COMPANIES = [
    ...
    },
    {
        ...
        package: '₹4.0 – 10.5 LPA', roles: ['SE', 'DSE', 'SP'], totalQuestions: 500,
        sections: ['Aptitude', 'Verbal', 'Reasoning', 'Pseudocode'],
        difficulty: 'Moderate–Hard', hiringPattern: 'Mass Hiring', badge: 'New',
        badgeColor: 'emerald', isLive: true,
    },
    {
        slug: 'wipro', name: 'Wipro', fullName: 'Wipro Limited',
        abbr: 'WIPRO', logoGradient: 'from-purple-500 to-purple-700', accentColor: 'purple', image: '/wipro.jpg',
        description: 'Elite NLTH exam. Unique for its mandatory Essay Writing section and strict time limits.',
        package: '₹3.5 LPA (Project Engineer)', roles: ['Project Engineer'], totalQuestions: 50,
        sections: ['Aptitude', 'Reasoning', 'Verbal', 'Essay', 'Coding'],
        difficulty: 'Moderate', hiringPattern: 'Mass Hiring', badge: 'New',
        badgeColor: 'purple', isLive: true,
    },
    {
        ...
        description: 'Hires via GenC, GenC Pro & GenC Next. Features Game-Based Aptitude and Communication tests.',
        package: '₹4.0 – 7.0 LPA', roles: ['GenC', 'GenC Pro', 'GenC Next'], totalQuestions: 143,
        sections: ['Communication', 'Game Aptitude', 'Technical', 'Coding'],
        difficulty: 'Moderate–Hard', hiringPattern: 'Mass Hiring', badge: 'New',
        badgeColor: 'sky', isLive: true,
    },
    {
        ...
        description: 'No negative marking. Comprehensive assessment with adaptive difficulty.',
        package: '₹4.5 – 10.0 LPA', roles: ['ASE', 'AAE', 'ADA'], totalQuestions: 142,
        sections: ['Cognitive', 'Technical', 'Coding', 'Communication'],
        difficulty: 'Moderate–Hard', hiringPattern: 'Mass Hiring', badge: 'New',
        badgeColor: 'pink', isLive: true,
    },
];
