            ...
            >
                ...
                >
                    <h1 className="text-2xl font-bold text-white tracking-tight">
                        Welcome to CodeHub <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-amber-500 drop-shadow-[0_0_8px_rgba(251,191,36,0.6)]">Pro</span> <span className="inline-block animate-bounce text-xl">🎉</span>
                    </h1>
